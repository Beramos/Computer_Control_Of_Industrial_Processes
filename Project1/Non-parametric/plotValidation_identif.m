...
% Importing data
data=importdata('IDENTIFICATION_PRESSURE_Save_01.txt');
...
figure; % plot data
subplot(2,1,1); hold on;  plot((0:199)*Ts,u); plot((200:400)*Ts,uValidation,'r'); hold off;
xlabel('time (s)'); ylabel('input signal (V)')
ylim([6 8])
subplot(2,1,2); hold on;  plot((0:199)*Ts,y); plot((200:400)*Ts,yValidation,'r'); hold off;
